...
<div class="col-sm-9 col-md-10 mt-3">
  <p class=" bg-dark text-white p-2 text-center">Work Order of Assigned Work</p>
  <?php
  ...
  <tbody>';
    ...
    <td><form action="viewassignedwork.php" method="POST" class="d-inline"> <input type="hidden" name="id" value=' . $row["request_id"] . '><button type="submit" class="btn btn-primary" name="view" value="View"><i class="far fa-eye"></i></button></form>
